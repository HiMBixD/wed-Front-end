...
import { NewAssignmentComponent } from './assignment-management/new-assignment/new-assignment.component';
...
export * from './assignment-management/new-assignment/new-assignment.component';
export * from './user-management/user-management.component'